unit Seven.DelphiAST.SymbolTable;

interface

uses
  System.Generics.Defaults, System.Generics.Collections, Seven.DelphiAST.MSXML2, System.Classes;
...
type
  ...
  TSymbol = class(TNoRefCountObject, IDelphiASTSymbol)
  private
  ...
  public
    constructor Create(
      ...
      Node: IXMLDOMNode;
      DeclLine, DeclColumn: Integer; FullFileName: string);
  ...
  TSymbolTable = class(TNoRefCountObject)
  private
    ...
    procedure AddSymbol(
      ...
      Node: IXMLDOMNode;
      Line, Column: Integer; FullFileName: string);
  ...
  public
    ...
    procedure Clear;
    procedure ProcessUnit(const FullFileName: string; const XMLDoc: IXMLDOMDocument2);
...
var
  ...
  NewSymbol: TSymbol;
begin
  NewSymbol := TSymbol.Create(FullyQualifiedName, SymbolKind, SymbolType, AncestorType, UnitSection, Node, Line, Column, FullFileName);
...
procedure TSymbolTable.ProcessUnit(const FullFileName: string; const XMLDoc: IXMLDOMDocument2);
var
  ...
  begin
    ...
    AddSymbol(SymbolFQN, SymbolKind, SymbolType, SymbolAncestorType, SymbolUnitSection, SymbolNode, Line, Col, FullFileName);
  end;
...
begin
  RetrieveUnitInfo(LowerCase(TPath.GetFileNameWithoutExtension(FullFileName)));
  ...
  SymbolNodes := XMLDoc.DocumentElement.SelectNodes(
    ...
    '/UNIT/IMPLEMENTATION//METHOD/STATEMENTS//VARIABLE' + ' | ' +
    '/UNIT/IMPLEMENTATION//METHOD/STATEMENTS//VARIABLES'
  );
...
function TSymbol.GetFullFileName(): string;
begin
